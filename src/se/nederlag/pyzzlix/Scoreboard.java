...
public class Scoreboard extends Sprite {
	...
	public Scoreboard() {
		...
		this.highscorelabeltext = new Text(12, 12, this.font, "HISCORE:");        
        this.highscoretext = new Text(76, 22, this.font, "0");
        this.highscoretext.setAnchor(Text.Anchor.RIGHT);
        
        this.scorelabeltext = new Text(12, 32, this.font, "SCORE:");
        this.scoretext = new Text(76, 42, this.font, "0");
